    ...
    <div>
      ...
      <div className="h-screen overflow-hidden flex items-center justify-center">
        <div className="w-full border shadow">
          <div className="flex">
            <div className="bg-purple-darker text-purple-lighter w-1/5 pb-6 hidden md:block">
              ...
              <div className="flex items-center mb-6 px-4">
                <span className="bg-green rounded-full block w-2 h-2 mr-2">span component</span>
              ...
              <div className="flex items-center px-4 mb-6">
                <span className="border rounded-full block w-2 h-2 mr-2">span component</span>
            ...
            <div className="w-full flex flex-col">
              <div className="border-b flex px-6 py-2 items-center">
                <div className="flex flex-col">
                  ...
                  <div className="text-grey font-thin text-sm">div component</div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="font-light text-md text-grey-darkest pt-1">
                      ...
                      the size of the generated CSS is creating a singularity in space/time, we must
                      stop adding more utilities before it too late
                    </p>
                  </div>
                </div>
              </div>
